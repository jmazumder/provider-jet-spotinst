...
import (
	...
	"github.com/jmazumder/provider-jet-spotinst/apis/v1alpha1"
)
...
const (
	...
	// Spotinst credentials environment variable names
	envAccount      = "SPOTINST_ACCOUNT"
	envToken        = "SPOTINST_TOKEN"
	envFeatureFlags = "SPOTINST_FEATURE_FLAGS"
)
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		ps.Configuration = map[string]interface{}{
			"account": spotinstCreds[keyAccount],
		}
		ps.Configuration = map[string]interface{}{
			"token": spotinstCreds[keyToken],
		}

		ps.Configuration = map[string]interface{}{
			"feature_flags": spotinstCreds[keyFeatureFlags],
		}
		...
		ps.Env = []string{
			...
			fmt.Sprintf(fmtEnvVar, envFeatureFlags, spotinstCreds[keyFeatureFlags]),
		}
		return ps, nil
	}
}
