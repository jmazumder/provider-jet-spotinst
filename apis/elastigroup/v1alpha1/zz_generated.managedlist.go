...
// GetItems of this AwsBeanstalkList.
func (l *AwsBeanstalkList) GetItems() []resource.Managed {
...
// GetItems of this AwsSuspensionList.
func (l *AwsSuspensionList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this AzureV3List.
func (l *AzureV3List) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
