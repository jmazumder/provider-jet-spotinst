...
func (mg *Gke) GetTerraformResourceType() string {
	return "spotinst_elastigroup_gke"
}
...
func (tr *Gke) GetObservation() (map[string]interface{}, error) {
...
func (tr *Gke) SetObservation(obs map[string]interface{}) error {
...
func (tr *Gke) GetParameters() (map[string]interface{}, error) {
...
func (tr *Gke) SetParameters(params map[string]interface{}) error {
