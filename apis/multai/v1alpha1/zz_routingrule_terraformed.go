...
func (mg *RoutingRule) GetTerraformResourceType() string {
	return "spotinst_multai_routing_rule"
}
...
func (tr *RoutingRule) GetObservation() (map[string]interface{}, error) {
...
func (tr *RoutingRule) SetObservation(obs map[string]interface{}) error {
...
func (tr *RoutingRule) GetParameters() (map[string]interface{}, error) {
...
func (tr *RoutingRule) SetParameters(params map[string]interface{}) error {
