...
func (tr *Check) GetObservation() (map[string]interface{}, error) {
...
func (tr *Check) SetObservation(obs map[string]interface{}) error {
...
func (tr *Check) GetParameters() (map[string]interface{}, error) {
...
func (tr *Check) SetParameters(params map[string]interface{}) error {
